...
const LEAF_FACES = [
  ...
  ASSETS + 'pages_tex/pg-05.jpg?v=4',
  ASSETS + 'pages_tex/pg-14.jpg?v=4',
  null,                           // 4 · «придбати»
];
...
export const BUY_URL = 'https://secure.wayforpay.com/button/be8d00dfb56c2';
  ...
  _input() {
    ...
    const up = (e) => {
      ...
      if (moved < 8 && performance.now() - t0 < 400 && this._hitBuy(sx, sy)) {
        /* та сама подія, що й на кнопках «Мами». Пікселя немає на кожній
           сторінці, звідки вантажиться блокнот, тому виклик необов'язковий */
